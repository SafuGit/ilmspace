  ...
  return (
    <header className="relative z-10 flex items-center justify-between px-8 py-5 w-full pointer-events-none">
      <div className="flex items-center gap-3 pointer-events-auto">
        <div className="text-(--accent-gold) size-8 opacity-90 drop-shadow-md">
      ...
      <div className="pointer-events-auto flex items-center gap-4">
        ...
        <button className="flex items-center justify-center size-10 rounded-full bg-black/20 hover:bg-(--accent-gold) hover:text-black transition-all duration-300 text-white/60 border border-white/5 shadow-lg group">
