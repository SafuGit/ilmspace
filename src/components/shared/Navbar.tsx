  ...
  return (
    <header className={`sticky top-0 z-50 flex items-center justify-between whitespace-nowrap border-b border-solid px-10 py-4 transition-all duration-300 ${
      ...
      <Link href="/" className="flex items-center gap-4 group">
        ...
        <h1 className="text-xl font-bold tracking-[-0.015em] transition-colors duration-300 group-hover:text-[#D4AF37]">IlmSpace</h1>
      </Link>
        ...
        <div className="flex items-center gap-4">
          ...
          {status === "authenticated" ? (
            <div className="relative">
              ...
              <div className={`absolute top-14 right-0 w-56 bg-card-bg/95 backdrop-blur-xl border border-border rounded-lg shadow-2xl overflow-hidden transition-all duration-300 origin-top-right ${
                showDropdown 
